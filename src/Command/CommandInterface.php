...
interface CommandInterface
{
    ...
    const COMMAND_HELP_DESC_DB = self::COMMAND_TEXT_DB . ' ' . self::CLEANUP_DESC . ' ' . self::AC_DESC;
    ...
    const AC_DESC = "Database operation '" . self::JOB_TYPE_AC . "' to find abandoned carts from ps_cart table.";

    // Messages
    const MSG_SUCCESS = '<info>Successfully executed jobCode: %s</info>';
    const MSG_ERROR = '<error>Error. Invalid jobCode: %s</error>';
